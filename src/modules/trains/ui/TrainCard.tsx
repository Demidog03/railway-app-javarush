...
export default function TrainCard({ segment, onBuyTickets }: { segment: TrainScheduleSegment, onBuyTickets?: () => void }) {
    ...
    return (
        <Card title={
            ...
            {onBuyTickets && (
                <Flex justify="flex-end" className={classes.buyButtonContainer}>
                    <Button onClick={onBuyTickets} icon={<ShoppingOutlined />} className={classes.buyButton} size="middle" variant="solid" color="geekblue">Buy tickets</Button>
                </Flex>
            )}
        </Card>
    );
